    ...
    <div class="col-sm-4 form-group">
      ...
      <div class="input-group">
        ...
        <span class="input-group-addon" style="padding:0;overflow:hidden;padding:0 10px;background:#fff;">
          <img style="height:60px" src="data:image/jpeg;base64,<?php echo $descargaCfdi->obtenerCaptcha(); ?>" />
        </span>
        <textarea tabindex="-1" name="sesion" style="display:none"><?php echo $descargaCfdi->obtenerSesion() ?></textarea>
      </div>
    </div>
